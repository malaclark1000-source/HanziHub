...
function Header({ userEmail, isAdmin }: { userEmail: string; isAdmin: boolean }) {
  ...
  const navLinks = (mobile?: boolean) => (
    <>
      ...
      <Link href="/dashboard" className={mobile ? 'text-sm px-3 py-1.5 rounded-lg bg-blue-50 text-blue-600 font-medium whitespace-nowrap' : 'text-blue-600 font-medium'}>My Downloads</Link>
